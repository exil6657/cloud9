...
void Client::registerFeatures() {
    for (const FeatureDescriptor& descriptor : featureCatalog()) {
        ...
        if (name == "Fullbright") {
            ...
            (void)modules_.registerModule(std::make_unique<Clock>());
        } else if (name == "Keystrokes") {
            (void)modules_.registerModule(std::make_unique<Keystrokes>());
        } else if (name == "CPS Counter") {
            (void)modules_.registerModule(std::make_unique<CPSCounter>());
        } else if (name == "Ping Display") {
            (void)modules_.registerModule(std::make_unique<PingDisplay>());
        } else if (name == "Speedometer") {
            (void)modules_.registerModule(std::make_unique<Speedometer>());
        } else if (name == "SessionInfo") {
            (void)modules_.registerModule(std::make_unique<SessionInfo>());
